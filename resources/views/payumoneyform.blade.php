  ...
  <div class="outer-w3-agile col-xl mt-3 mr-xl-3">
    <form action="https://test.payu.in/_payment" method="post" name="payuForm">
      ...
      <table>
        ...
        <tr>
          <td>Success URI: </td>
          <td colspan="3"><input type="text" name="surl" value="{{Route('payment_view_sucess')}}" size="64" /></td>
        </tr>
        <tr>
          <td>Failure URI: </td>
          <td colspan="3"><input type="text" name="furl" value="{{Route('payment_view_failure')}}" size="64" /></td>
        </tr>
