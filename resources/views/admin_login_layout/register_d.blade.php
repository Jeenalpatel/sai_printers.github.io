		...
		.registration_main
{
	...
	width: 100%;
	background-image: url(../img1/reg.jpg);
	object-fit: cover;
...
.registration_main .visi1 ,.visi2,.visi3,.visi4,.visi5
{
	height: 250px;
	width: 450px;
	position: relative;
	...
	background-image: url(../img1/visi1.png);
	background-position: center;
	background-size: cover;
	object-fit: cover;
	background-repeat: no-repeat;
}
.registration_main .visi2
{
	position: relative;
	height: 350px;
	width: 300px;
	...
	margin-top: -130px;
	z-index: 3;
	background-image: url(../img1/bill.png);
}
.registration_main .visi3
{
	background-image: url(../img1/kankotri.png);
	height: 250px;
	width: 300px;
	position: relative;
	top: -300px;
...
.registration_main .visi4
{
	background-image: url(../img1/latter_pad1.jpg);
	height: 300px;
	width: 200px;
	z-index: 2;
	margin-top: -450px;
...
.registration_main .visi5
{
	background-image: url(../img1/visi2.png);
	transform: skewX(-10deg);
	margin-top: -200px;
	position: relative;
	left: 190px;
							...
							<div class="col-lg-6">
								<div class="file-upload">
								  <div class="file-select">
								    <div class="file-select-button" id="fileName">Profile Photo</div>
