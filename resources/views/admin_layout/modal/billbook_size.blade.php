...
<div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form data-parsley-validate class="form-horizontal form-label-left" action="{{route('bill_book_size_insert')}}" enctype="multipart/form-data" method="POST">
                        {{csrf_field()}}
