...
<div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form data-parsley-validate class="form-horizontal form-label-left" action="{{route('handbill_pricelist_insert')}}" enctype="multipart/form-data" method="POST">
                        {{csrf_field()}}
                    ...
                    <br/>
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" name="price_per_handbill" class="form-control " require>
                          </div>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title">Price_per_handbill </th>
                        ...
                        @forelse($data as $d)
                          ...
                          <tr class="even pointer">
                            ...
                            <td class=" ">{{$d->side1}}</td>
                            <td class=" ">{{$d->price_per_handbill}}</td>
