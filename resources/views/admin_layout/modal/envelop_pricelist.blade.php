...
<div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form data-parsley-validate class="form-horizontal form-label-left" action="{{route('envelop_pricelist_insert')}}" enctype="multipart/form-data" method="POST">
                        {{csrf_field()}}
                    ...
                    <br/>
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" name="price_per_envelop" class="form-control " require>
                          </div>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        @forelse($data as $d)
                          ...
                          <tr class="even pointer">
                            ...
                            <td class=" ">{{$d->quality1}}</td>c
                            <td class=" ">{{$d->quantity1}}</td>
                             

                            <td class=" ">{{$d->price_per_envelop}}</td>
