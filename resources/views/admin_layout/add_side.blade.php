...
<div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form data-parsley-validate class="form-horizontal form-label-left" action="{{route('side_insert')}}" enctype="multipart/form-data" method="POST">
                        {{csrf_field()}}
                    ...
                    <br/>
                        <div class="col-md-6 col-sm-6 ">
                          <select name="quality_id" id="quality" class="form-control" >
                    ...
                    <br/>
                        <div class="col-md-6 col-sm-6 ">
                          <select  name="quantity_id" id="quantity" class="form-control" >
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title">visiting card side</th>
