...
<div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form data-parsley-validate class="form-horizontal form-label-left" action="{{route('q_insert1')}}" enctype="multipart/form-data" method="POST">
                        {{csrf_field()}}
                    ...
                    <br/>
                        <div class="col-md-6 col-sm-6 ">
                          <select id="type" name="quality_id" class="form-control" >
                    ...
                    <br/>
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" name="q_value" class="form-control " require>
                          </div>
