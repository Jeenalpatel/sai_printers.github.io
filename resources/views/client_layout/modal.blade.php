      ...
      <div class="col-lg-6">
        ...
        @endforelse
            ...
            <div class="row p_second_row">
              ...
              <div class="col-lg-8">
                <select id="quantity" name="quantity" @if(@$data1->quality == $q->id){{'selected'}}@elseif(old('q_name') == $q->id){{'selected'}}@else{{'disabled'}}@endif>
            ...
            <div class="row p_three_row">
              ...
              <div class="col-lg-8">
                <select name="side" id="side">
                  <option selected disabled hidden >select Side</option>
                  @forelse($side as $q)
            ...
            <div class="row">
              <div class="col-lg-12">  
                <div class="sub_btn"><input type="submit" name="" value="Starting Design"></div>
              </div>
            </div>
          </form>
